...
<optgroup label="<?php echo __('General - Continent', 'gmc'); ?>">
            <?php echo gmc_option_list(array(__('African', 'gmc') => __('African', 'gmc'), __('American', 'gmc') => __('American', 'gmc'), __('Asian', 'gmc') => __('Asian', 'gmc'), __('European', 'gmc') => __('European', 'gmc'), __('Oceanian', 'gmc') => __('Oceanian', 'gmc'), __('South American', 'gmc') => __('South American', 'gmc')), $selectedregion[0]->name); ?>

          </optgroup><optgroup label="<?php echo __('Specific - Region', 'gmc'); ?>">
            <?php echo gmc_option_list(array(__('British', 'gmc') => __('British', 'gmc'), __('Canadian', 'gmc') => __('Canadian', 'gmc'), __('Chinese', 'gmc') => __('Chinese', 'gmc'), __('Croatian', 'gmc') => __('Croatian', 'gmc'), __('French', 'gmc') => __('French', 'gmc'), __('German', 'gmc') => __('German', 'gmc'), __('Greek', 'gmc') => __('Greek', 'gmc'), __('Indian', 'gmc') => __('Indian', 'gmc'), __('Indonesian', 'gmc') => __('Indonesian', 'gmc'), __('Irish', 'gmc') => __('Irish', 'gmc'), __('Italian', 'gmc') => __('Italian', 'gmc'), __('Jamaican', 'gmc') => __('Jamaican', 'gmc'), __('Japanese', 'gmc') => __('Japanese', 'gmc'), __('Lebanese', 'gmc') => __('Lebanese', 'gmc'), __('Malaysian', 'gmc') => __('Malaysian', 'gmc'), __('Mexican', 'gmc') => __('Mexican', 'gmc'), __('Moroccan', 'gmc') => __('Moroccan', 'gmc'), __('Nigerian', 'gmc') => __('Nigerian', 'gmc'), __('Russian', 'gmc') => __('Russian', 'gmc'), __('Spanish', 'gmc') => __('Spanish', 'gmc'), __('Swedish', 'gmc') => __('Swedish', 'gmc'), __('Thai', 'gmc') => __('Thai', 'gmc'), __('Turkish', 'gmc') => __('Turkish', 'gmc'), __('Vietnamese', 'gmc') => __('Vietnamese', 'gmc')), $selectedregion[0]->name); ?>
