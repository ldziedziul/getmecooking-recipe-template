...
define('GMC_URL', 'http://localhost:63459/recipeservice.svc/submitrecipe');
...
add_action('tiny_mce_preload_dialogs', 'gmc_insert_recipe_dialog');
...
// fix - causes Recipe view to loop
